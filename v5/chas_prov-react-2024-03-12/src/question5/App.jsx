...
// (definierad av children som skickas till komponenten).
...
// "Visa/Göm"-knapp som låter användaren växla
...
//    children baserat på användarens interaktion med "Visa/Göm"-knappen.
...
function App() {
  return (
    <div>
      ...
      <Panel title="Panel 2" collapsible={false}>
